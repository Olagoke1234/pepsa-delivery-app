...
const ScheduleDeliveryPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="schedule-delivery-content" style={{ padding: "20px" }}>
        <p
        ...
        <form id="schedule-delivery-form">
          ...
          <div className="form-group">
            <label
              htmlFor="schedule-delivery-location"
              style={{ fontSize: "14px", marginBottom: "10px" }}
            >
              Delivery Location
            </label>
